...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    return {
        title: `Términos | ${t('title')}`,
        description: 'Términos y Condiciones de Scryved.',
    };
}
...
export default function TermsPage() {
    ...
    return (
        <div className="min-h-[100dvh] pt-32 pb-20 relative overflow-hidden" style={{ background: '#050505' }}>
            ...
            <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-[#a3e635]/5 rounded-full blur-[120px] pointer-events-none" />
